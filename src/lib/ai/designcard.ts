...
> 由创作者（老板）与 AI 工作室共同维护，是各职能间的共享记忆。
> 「状态」一行是创作流程的开关：需求对齐中 → 方案待确认 → 已确认 →（实现后）调优中。
> AI 只有在状态为「已确认」之后才被允许生成/修改游戏配置。
> 板块分工：世界观/结局叙事=剧情策划；人物与人设=人设师；数值体系=数值策划；其余=主策。
...
## 人物与人设
（主要角色/阵营：名字、身份、动机、口癖或记忆点；谁与玩家有羁绊/冲突；
角色的秘密与弧光——哪怕经营类也要有让玩家记得住的人）
